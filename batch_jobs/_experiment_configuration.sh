...
persistent_dir="/homes/iws/nickhit3/cse481n-project"
...
masked_lm_base_models=(
    "BertForMaskedLM"
    "RobertaForMaskedLM"
)

masked_lm_quant_models=(
    "QuantizedBertModelMaskedLM"
    "QuantizedRobertaModelMaskedLM"
)

distil_masked_lm_models=(
...
declare -A model_to_distilmodel_name_or_path=(
    ["DistilBertModel"]="distilbert-base-uncased"
    ["DistilBertForMaskedLM"]="distilbert-base-uncased"
    ["DistilRobertaModel"]="distilroberta-base"
    ["DistilRobertaForMaskedLM"]="distilroberta-base"
)

declare -A model_to_largemodel_name_or_path=(
    ["BertModel"]="bert-large-uncased"
    ["BertForMaskedLM"]="bert-large-uncased"
    ["RobertaModel"]="roberta-large"
    ["RobertaForMaskedLM"]="roberta-large"
)

declare -A model_to_quantlargemodel_name_or_path=(
    ["QuantizedBertModel"]="bert-large-uncased"
    ["QuantizedBertModelMaskedLM"]="bert-large-uncased"
    ["QuantizedRobertaModel"]="roberta-large"
    ["QuantizedRobertaModelMaskedLM"]="roberta-large"
)

declare -A model_to_quantbasemodel_name_or_path=(
    ["QuantizedBertModel"]="bert-base-uncased"
    ["QuantizedBertModelMaskedLM"]="bert-base-uncased"
    ["QuantizedRobertaModel"]="roberta-base"
    ["QuantizedRobertaModelMaskedLM"]="roberta-base"
)
